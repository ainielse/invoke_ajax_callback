...
,p_release=>'23.1.5'
,p_default_workspace_id=>2006743728505847
,p_default_application_id=>111
,p_default_id_offset=>0
,p_default_owner=>'APEXIA'
);
end;
/
 
prompt APPLICATION 111 - anton dropme
--
-- Application Export:
--   Application:     111
--   Name:            anton dropme
--   Date and Time:   09:59 Friday July 5, 2024
--   Exported By:     ANTON.NIELSEN@TALAN.COM
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     PLUGIN: 10802066559581551704
--   Manifest End
--   Version:         23.1.5
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(10802066559581551704)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11321366137172208145)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11321348785386957950)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(11478417032398259176)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(6169429849625823397)
,p_plugin_attribute_id=>wwv_flow_imp.id(11478417032398259176)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11478941735407262627)
,p_plugin_attribute_id=>wwv_flow_imp.id(11478417032398259176)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11479001445682266955)
,p_plugin_attribute_id=>wwv_flow_imp.id(11478417032398259176)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(11478629768375525617)
,p_plugin_attribute_id=>wwv_flow_imp.id(11478417032398259176)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5802742267436720213)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(11478417032398259176)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'EVENT'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(5802114572824467922)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6210058337492380249)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6238814723156710042)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6238899616869724469)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(6220391819523474947)
,p_plugin_id=>wwv_flow_imp.id(10802066559581551704)
,p_attribute_scope=>'COMPONENT'
